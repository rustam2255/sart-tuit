const StudentsRatingCard = ({item}) => {
  return (
    <div className="border rounded-[20px] p-6 flex flex-col justify-between gap-9">
      <h2 className="uppercase text-xl text-[rgba(0, 0, 0, 1)] text-center">{item.name} SONI</h2>
